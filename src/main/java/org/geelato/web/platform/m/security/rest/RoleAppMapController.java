...
public class RoleAppMapController extends BaseController {
    ...
    public ApiPagedResult pageQuery(HttpServletRequest req) {
        ...
        try {
            ...
            List<RoleAppMap> pageQueryList = roleAppMapService.pageQueryModel(RoleAppMap.class, pageNum, pageSize, params);
            List<RoleAppMap> queryList = roleAppMapService.queryModel(RoleAppMap.class, params);
