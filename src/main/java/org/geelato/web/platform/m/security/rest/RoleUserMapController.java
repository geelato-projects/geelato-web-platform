...
public class RoleUserMapController extends BaseController {
    ...
    public ApiPagedResult pageQuery(HttpServletRequest req) {
        ...
        try {
            ...
            List<RoleUserMap> pageQueryList = roleUserMapService.pageQueryModel(RoleUserMap.class, pageNum, pageSize, params);
            List<RoleUserMap> queryList = roleUserMapService.queryModel(RoleUserMap.class, params);
