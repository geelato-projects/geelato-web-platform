...
public class ViewController extends BaseController {
    ...
    public ApiPagedResult pageQuery(@PathVariable("view_name") String viewName, HttpServletRequest req) {
        ...
        try {
            int pageNum = StringUtils.isNotBlank(req.getParameter("current")) ? Integer.parseInt(req.getParameter("current")) : -1;
            int pageSize = StringUtils.isNotBlank(req.getParameter("pageSize")) ? Integer.parseInt(req.getParameter("pageSize")) : -1;
