...
public class RoleTreeNodeMapController extends BaseController {
    ...
    public ApiPagedResult pageQuery(HttpServletRequest req) {
        ...
        try {
            ...
            List<RoleTreeNodeMap> pageQueryList = roleTreeNodeMapService.pageQueryModel(RoleTreeNodeMap.class, pageNum, pageSize, params);
            List<RoleTreeNodeMap> queryList = roleTreeNodeMapService.queryModel(RoleTreeNodeMap.class, params);
